package com.britishenglishcertificate.gowrishankar.utils;
...
public class MyConstant {
        ...
        // swagger
        public static final String SWAGGER_INFO_TITLE = "Bec";
        public static final String SWAGGER_INFO_DESCRIPTION = "My website is a educational platform that provides different english learning courses";
        public static final String SWAGGER_INFO_VERSION = "1.0.0";
        public static final String SWAGGER_INFO_CONTACT_NAME = "Gowri Shankar S";
        public static final String SWAGGER_INFO_CONTACT_EMAIL = "727722eucs508@skcet.ac.in";
        public static final String SWAGGER_INFO_CONTACT_URL = "https://bec.com";
